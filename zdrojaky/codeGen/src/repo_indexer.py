...
# DIRECTORY = "C:\\School\\UK_mAIN\\Diplomova praca\\Cast testy\\RimskaKalkulacka\\test gpt kodu v java projekte\\romanCalculator"
# DIRECTORY = "C:\\School\\UK_mAIN\\Diplomova praca\\Cast testy\\TestRepoJS"
# DIRECTORY = "C:\\School\\UK_mAIN\\Diplomova praca\\Cast testy\\DanoMasar\\futurabm-dev-main-test-coreapp"
...
def index_repo_files_with_ext(directory, ext):
    ...
    # TODO: possible problem when saving path in (source) in windows and unix \\ vs //
